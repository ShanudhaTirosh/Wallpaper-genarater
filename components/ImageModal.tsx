...
import { motion, AnimatePresence, Variants } from 'framer-motion'; // Added AnimatePresence, Variants
        ...
        <div className="w-full md:w-[400px] bg-zinc-900 border-l border-white/5 flex flex-col h-auto md:h-full z-20 shadow-xl">
           ...
           <div className="p-6 border-t border-white/5 bg-zinc-900 relative z-30">
              <motion.button 
                ...
                className="w-full flex items-center justify-center space-x-2 bg-white text-black px-4 py-4 rounded-xl font-bold hover:bg-zinc-200 transition-all shadow-lg shadow-white/5 mb-3"
              >
